package m2166.com.testmvpdemo.page.mediaplay.mediaview;
...
public class MediaViewActivity extends MVPBaseActivity<MediaViewActivity, MediaViewPresenterImp> implements MediaViewView {
    Activity mActivity;
    @BindView(R.id.tb_appbar)
    Toolbar tbAppbar;

    @Override
    protected MediaViewPresenterImp createPresenter() {
        return new MediaViewPresenterImp();
    }
